...
from nrp.planner.local_sampler_g.local_sampler_g import LocalNeuralExpander8D, LocalNeuralExpander11D
...
class NRP_g:
    ...
    def __init__(self, env, model_path, optimal=False, dim=8, occ_grid_dim=[1, 40, 40], device=torch.device("cuda")):
        ...
        print(f"=============== RRT_NE_G Optimal: {optimal} =================")
        if not optimal:
