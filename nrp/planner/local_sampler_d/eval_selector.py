...
if __name__ == '__main__':
    ...
    model = DiscriminativeSampler(robot_dim, occ_grid_dim, os.path.join(CUR_DIR, "models/model_col.pt"), osp.join(CUR_DIR, 'models/{}.pt'.format(args.checkpoint)))
    ...
    disp.plot()
    plt.savefig("sel_confusion_matrix.png")