...
from model import Selector, SelectorSmall
import utils
...
if __name__ == '__main__':
    ...
    data_dir = osp.join(CUR_DIR, "./dataset/model_sel_global")
    eval_data_dir = osp.join(CUR_DIR, "./dataset/model_sel_eval_global")
    ...
    if USE_WEIGHTED_SAMPLER:
        data_cnt = 12466118
        pos_data_cnt = 2472454
        neg_data_cnt = 9993664
    else:
        data_cnt = 100000
    eval_data_cnt = 10000
    ...
    model = SelectorSmall(robot_dim + linkpos_dim, goal_dim, occ_grid_size=occ_grid_dim)
    if args.checkpoint != '':
    ...
    for iter_num in range(num_epochs):
        ...
        for data in dataloader:
            ...
            if train_num % 100 == 0:
                ...
                print('Loss after epoch %d, mini-batch %5d, dataset_sizes %d: , sel_pred: %.3f' % (iter_num, train_num, data_cnt, loss.item()))
        ...
        writer.add_scalar('dataset_sel_accuracy/iter', accuracy, iter_num)
        writer.add_scalar('dataset_sel_precision/iter', precision, iter_num)
        writer.add_scalar('dataset_sel_recall/iter', recall, iter_num)
