...
if __name__ == '__main__':
    ...
    # data_dir = osp.join(CUR_DIR, "./dataset/{}".format(args.datadir))
    # eval_data_dir = osp.join(CUR_DIR, "./dataset/{}_eval".format(args.datadir))
    if USE_WEIGHTED_SAMPLER:
        data_dir = osp.join(CUR_DIR, "./dataset/model_sel_imbal")
    else:
        data_dir = osp.join(CUR_DIR, "./dataset/model_sel")
    ...
    model = SelectorSmall(robot_dim + linkpos_dim, goal_dim)
    if args.checkpoint != '':
