...
class MyDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        occ_grid, start_pos, goal_pos, sample, _, _ = data
...
occ_grid_dim = 100
model_name = "cvae_sel_global"
path = osp.join(CUR_DIR, "models/{}.pt".format(model_name))
data_dir = osp.join(CUR_DIR, "dataset/model_train_global")
...
print("dim = ", robot_dim)
print("z_dim = ", z_dim)
model = VAE(occ_grid_dim, z_dim, robot_dim + linkpos_dim + goal_dim, robot_dim + linkpos_dim)
if args.checkpoint != '':
