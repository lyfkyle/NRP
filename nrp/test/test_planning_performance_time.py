...
for repeat in range(num_repeat):
    ...
    for i in range(env_num):
        ...
        if args.planner.startswith("rrt"):
            ...
            total_col_check_time += decomposed_rrt_planner.col_check_time / (
                decomposed_rrt_planner.algo.num_expansions + 1e-8
            )
            total_expansion_success += (
                decomposed_rrt_planner.algo.num_expansions - decomposed_rrt_planner.expansion_col_cnt
            )
