...
parser.add_argument('--name',  default='test_ext_v3')
...
if args.planner.startswith('neural_d'):
    ...
    sl_bias = 0.01
    col_checker_path = osp.join(CUR_DIR, "../local_sampler_d/models/model_col_global.pt")
    selector_path = osp.join(CUR_DIR, "../local_sampler_d/models/model_sel_global.pt")
    neural_planner_d = RRT_NE_D_Global(col_checker_path, selector_path)
