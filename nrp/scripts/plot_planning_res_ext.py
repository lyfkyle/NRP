...
planners = ["neural_d_no_col", "neural_g", "cvae", "rrt", "rrt_is"]
...
planners = ["neural_d_no_col", "neural_g", "cvae", "fire", "rrt", "rrt_is"]
...
plt.savefig(osp.join(CUR_DIR, "planning_res_ext_v4.png"), bbox_inches="tight")
