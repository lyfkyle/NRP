...
# 8D
# planners = ["neural_d", "neural_g", "cvae", "rrt", "rrt_is", "vqmpt_rrt"]
# legends = ["NRP-d", "NRP-g", "CVAE-RRT", "RRT", "RRT-IS", "VQMPT"]
planners = ["neural_d", "neural_g", "cvae", "rrt", "rrt_is"]
legends = ["NRP-d", "NRP-g", "CVAE-RRT", "RRT", "RRT-IS"]
...
for i, planner in enumerate(planners):
    ...
    for repeat in range(args.repeat):
        with open(
            ...
            planner_success_cnt = (
                planner_success_tmp["base_success_list"] if i >= 3 else planner_success_tmp["success_list"]
            )
...
# 11D
planning_time = np.arange(0, 10.1, 0.5)
# planners = ["neural_d", "neural_g", "cvae", "fire", "rrt", "rrt_is", "vqmpt_rrt"]
# legends = ["NRP-d", "NRP-g", "CVAE-RRT", "FIRE", "RRT", "RRT-IS", "VQMPT"]
# planners = ["neural_d", "neural_g", "cvae", "fire", "rrt", "rrt_is"]
# legends = ["NRP-d", "NRP-g", "CVAE-RRT", "FIRE", "RRT", "RRT-IS"]
planners = ["nrp_d", "nrp_g", "cvae", "fire", "rrt", "rrt_is"]
legends = ["NRP-d", "NRP-g", "CVAE-RRT", "FIRE", "RRT", "RRT-IS"]
env_num = 250
...
plt.savefig(osp.join(CUR_DIR, "planning_res_timing.png"), bbox_inches="tight")
