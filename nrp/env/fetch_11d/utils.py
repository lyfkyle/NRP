...
TRAIN_ENV_DICT = {
    0: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Ranchester",
    1: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Klickitat",
    2: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Hiteman",
    3: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Onaga",
    4: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Pinesdale",
    5: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Wainscott",
    6: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Forkland",
    7: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Marstons",
    8: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Leonardo",
    9: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Benevolence",
    10: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Mifflinburg",
    11: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Cosmos",
    12: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Shelbyville",
    13: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Stockman",
    14: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Merom",
    15: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Pomaria",
    16: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Woodbine",
    17: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Lindenwood",
    18: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Allensville",
    19: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Newfields",
    20: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Lakeville",
    21: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Hanson",
    22: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Coffeen",
    23: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Beechwood",
    24: "/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/train/Tolstoy",
}
TRAIN_ENV_DIRS = list(TRAIN_ENV_DICT.values())
# print(TRAIN_ENV_DIRS)

TEST_ENV_DICT = {
    0: '/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/test/Wiconisco',
    1: '/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/test/Markleeville',
    2: '/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/test/Azusa',
    3: '/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/test/Corozal',
    4: '/data/yunlu/work/whole-body-motion-planning/nrp/env/fetch_11d/dataset/gibson_01/test/Ihlen'
}
TEST_ENV_DIRS = list(TEST_ENV_DICT.values())

# train_env_dir = osp.join(CUR_DIR, "dataset/gibson_01/train")
# env_idx = 0
# for p in Path(train_env_dir).rglob("env.obj"):
#     TRAIN_ENV_DIRS.append(p.parent)
#     TRAIN_ENV_DICT[env_idx] = str(p.parent)
#     env_idx += 1
# print(TRAIN_ENV_DICT)
...
def get_occ_grid(env_dir):
    with open(os.path.join(env_dir, "occ_grid.npy"), "rb") as f:
        occ_grid = np.load(f)
    return occ_grid


def get_prm(env_dir):
    g = nx.read_graphml(osp.join(env_dir, "dense_g.graphml"))
    return g


def get_mesh_path(env_dir):
    return osp.join(env_dir, "env.obj")
